...
public partial class TestChargeCalculator
{
    ...
    private static CalculationParameters GetCalculation6Parameters(CarType carType) =>
       new(
            new Trip[]
            {
                new(
                    Entering: new(2022, 1, 10, 8, 45, 0),
                    Leaving: new(2022, 1, 10, 15, 15, 0),
                    DetectionsInside: Array.Empty<DateTime>()),
                new(
                    Entering: new(2022, 1, 10, 17, 10, 0),
                    Leaving: new(2022, 1, 10, 18, 30, 0),
                    DetectionsInside: Array.Empty<DateTime>()),
            },
            DayToCalculate: new(2022, 1, 10),
            carType,
            IsElectricOrHybrid: false);
    ...
    private static CalculationParameters GetExample7Parameters(DateTime dayToCalculate) =>
        new(
            ...
            {
                new(
                    Entering: new(2022, 1, 14, 13, 10, 0),
                    Leaving: null,
                    DetectionsInside: Array.Empty<DateTime>()),
            },
            dayToCalculate,
